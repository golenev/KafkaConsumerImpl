...
- `:` (корневой модуль) — агрегатор Gradle с общими настройками и инфраструктурными файлами. Тестовые Kafka-утилиты вынесены в модуль `validator-e2e-tests`.
